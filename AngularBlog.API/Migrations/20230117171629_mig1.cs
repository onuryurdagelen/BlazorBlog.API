    ...
    public partial class mig1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserAppClaims", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserAppClaims_AppClaims_AppClaimId",
                        column: x => x.AppClaimId,
                        principalTable: "AppClaims",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserAppClaims_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserAppClaims_AppClaimId",
                table: "UserAppClaims",
                column: "AppClaimId");

            migrationBuilder.CreateIndex(
                name: "IX_UserAppClaims_UserId",
                table: "UserAppClaims",
                column: "UserId");
        }
